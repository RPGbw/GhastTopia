package com.zidiansyncs.ghasttopia;
...
@Mod(GhastTopia.MODID)
public class GhastTopia {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "ghasttopia";
    ...
    public static final DeferredHolder<JukeboxSong, JukeboxSong> CLOUDSTRIDE_JUKEBOX_SONG = JUKEBOX_SONGS.register("cloudstride",
        () -> new JukeboxSong(
            ...
            Component.translatable("item.ghasttopia.music_disc_cloudstride.desc"), // Description text
    ...
    // Creates a creative tab with the id "ghasttopia:ghast_topia_tab" for the example item, that is placed after the combat tab


    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public GhastTopia(IEventBus modEventBus, ModContainer modContainer) {
    ...
    public void onRegisterCommands(RegisterCommandsEvent event) {
        ...
        LOGGER.info("Registered GhastTopia debug commands");
    }
}
