 ...
 */
@EventBusSubscriber(modid = HappyHaulers.MODID)
public class ServerEventHandlers {
    ...
    public static void onServerStarted(ServerStartedEvent event) {
        System.out.println("HappyHaulers: Server started - resetting texture data flags");
        
        // Reset flags so data can be loaded when levels load
        hasLoadedTextureData = false;
        HappyGhastTextureManager.resetDataLoadedFlag();
        
        System.out.println("HappyHaulers: Ready to load texture data when levels load");
    }
    ...
    public static void onServerStopping(ServerStoppingEvent event) {
        System.out.println("HappyHaulers: Server stopping, saving Happy Ghast texture data from memory");
        ...
        if (levels.iterator().hasNext()) {
            ...
            System.out.println("HappyHaulers: Saving texture data to file");
    ...
    public static void onLevelLoad(LevelEvent.Load event) {
        System.out.println("HappyHaulers: LevelEvent.Load triggered for: " + event.getLevel().getClass().getSimpleName());

        if (!(event.getLevel() instanceof ServerLevel serverLevel)) {
            System.out.println("HappyHaulers: Not a ServerLevel, skipping texture data load");
            return;
        }

        // Only load data once when the first dimension loads
        if (!hasLoadedTextureData && serverLevel != null) {
            System.out.println("HappyHaulers: " + serverLevel.dimension().location() + " loaded, restoring Happy Ghast texture data");
            ...
            System.out.println("HappyHaulers: " + serverLevel.dimension().location() + " loaded, but texture data already loaded");
